(function(){
let a 	=	document.querySelector('div#allvendors');
...
u.forEach((p)=>{
	...
	let f 	=	p.querySelector('p#vendor-status');
	let z	=	p.querySelector('data#vendor-header').getAttribute('value');
	w.onclick = function(){
