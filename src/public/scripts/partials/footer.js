(function(ww){
	let bh 	= document.querySelector('#navalign'),
...
function notfn(i){
		...
		w.onreadystatechange	=	()=>{
										if(w.readyState === XMLHttpRequest.DONE && w.status === 200){	
																									...
																									let dh	= document.querySelectorAll('div#NotDropMenu a');
																									dh.forEach((a)=>{
...
function menuitm(k){
	...
	u.onreadystatechange	=	()=>{
										if(u.readyState === XMLHttpRequest.DONE && u.status === 200){	
																									...
																									let	ah 	= document.querySelectorAll('div#dropMenu a');
																									ah.forEach((a)=>{
																														a.addEventListener("mouseover", ()=>{
																															a.classList.add('bg-secondary');
																														});
